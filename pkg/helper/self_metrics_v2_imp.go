...
func (e *errorNumericMetric) Add(f int64) {
	logger.Warning(context.Background(), util.InternalMetricAlarm, "add", e.err)
}

func (e *errorNumericMetric) Set(f float64) {
	logger.Warning(context.Background(), util.InternalMetricAlarm, "set", e.err)
}

func (e *errorNumericMetric) Observe(f float64) {
	logger.Warning(context.Background(), util.InternalMetricAlarm, "observe", e.err)
}
