...
func TestWarn(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				ctx:       ctx,
				alarmType: util.PARSE_LOG_FAIL_ALARM,
				kvPairs:   []interface{}{"a", "b"},
			},
			want: ".*\\[WRN\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] \\[mock-configname,mock-logstore\\]\tAlarmType:PARSE_LOG_FAIL_ALARM\t\\[a b\\]:.*",
			getter: func() *util.Alarm {
		...
		},
		{
			...
			args: args{
				ctx:       context.Background(),
				alarmType: util.DISCARD_DATA_ALARM,
				kvPairs:   []interface{}{"a", "b"},
			},
			want: ".*\\[WRN\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] AlarmType:DISCARD_DATA_ALARM\t\\[a b\\]:.*",
			getter: func() *util.Alarm {
...
func TestWarnf(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: ".*\\[WRN\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] AlarmType:DISCARD_DATA_ALARM\ttest \\[a\\].*",
			getter: func() *util.Alarm {
				return util.GlobalAlarm
			},
		},
		{
			...
			want: ".*\\[WRN\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] \\[mock-configname,mock-logstore\\]\tAlarmType:PARSE_LOG_FAIL_ALARM\ttest \\[a\\].*",
...
func TestError(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: ".*\\[ERR\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] \\[mock-configname,mock-logstore\\]\tAlarmType:PARSE_LOG_FAIL_ALARM\t\\[a b\\]:.*",
			getter: func() *util.Alarm {
				return ctx.Value(pkg.LogTailMeta).(*pkg.LogtailContextMeta).GetAlarm()
			},
		},
		{
			...
			want: ".*\\[ERR\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] AlarmType:DISCARD_DATA_ALARM\t\\[a b\\]:.*",
			getter: func() *util.Alarm {
				return util.GlobalAlarm
			},
		},
...
func TestErrorf(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: ".*\\[ERR\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] AlarmType:DISCARD_DATA_ALARM\ttest \\[a\\].*",
			getter: func() *util.Alarm {
				return util.GlobalAlarm
			},
		},
		{
			...
			want: ".*\\[ERR\\] \\[logger_test.go:\\d{1,}\\] \\[func\\d{1,}\\] \\[mock-configname,mock-logstore\\]\tAlarmType:PARSE_LOG_FAIL_ALARM\ttest \\[a\\].*",
			getter: func() *util.Alarm {
				return ctx.Value(pkg.LogTailMeta).(*pkg.LogtailContextMeta).GetAlarm()
			},
		},
...
func TestOffRemote(t *testing.T) {
	...
	clean()
	initTestLogger()
	Warning(context.Background(), util.ALL_LOGTAIL_ALARM_NUM, "a", "b")
	assert.Equal(t, 0, len(util.GlobalAlarm.AlarmMap))
	Error(context.Background(), util.ALL_LOGTAIL_ALARM_NUM, "a", "b")
	assert.Equal(t, 0, len(util.GlobalAlarm.AlarmMap))
	Warningf(context.Background(), util.ALL_LOGTAIL_ALARM_NUM, "test %s", "b")
	assert.Equal(t, 0, len(util.GlobalAlarm.AlarmMap))
	Errorf(context.Background(), util.ALL_LOGTAIL_ALARM_NUM, "test %s", "b")
	assert.Equal(t, 0, len(util.GlobalAlarm.AlarmMap))
	delete(util.GlobalAlarm.AlarmMap, util.ALL_LOGTAIL_ALARM_NUM)
}
