...
func TestOffRemote(t *testing.T) {
	...
	clean()
	initTestLogger()
	Warning(context.Background(), selfmonitor.ConfigLoadAlarm, "a", "b")
	assert.Equal(t, 0, len(selfmonitor.GlobalAlarm.AlarmMap))
	Error(context.Background(), selfmonitor.ConfigLoadAlarm, "a", "b")
	assert.Equal(t, 0, len(selfmonitor.GlobalAlarm.AlarmMap))
	Warningf(context.Background(), selfmonitor.ConfigLoadAlarm, "test %s", "b")
	assert.Equal(t, 0, len(selfmonitor.GlobalAlarm.AlarmMap))
	Errorf(context.Background(), selfmonitor.ConfigLoadAlarm, "test %s", "b")
	assert.Equal(t, 0, len(selfmonitor.GlobalAlarm.AlarmMap))
	delete(selfmonitor.GlobalAlarm.AlarmMap, selfmonitor.ConfigLoadAlarm.String())
}
