...
func TestOptionWarnLevel(t *testing.T) {
	...
	Info(context.Background(), "line")
	assert.True(t, readLog(0) == "")
	Warning(context.Background(), selfmonitor.ConfigLoadAlarm, "line")
	assert.True(t, readLog(0) != "")
}
...
func TestOptionErrorLevel(t *testing.T) {
	...
	Warning(context.Background(), selfmonitor.ConfigLoadAlarm, "")
	assert.True(t, readLog(0) == "")
	Error(context.Background(), selfmonitor.ConfigLoadAlarm, "line")
	assert.True(t, readLog(0) != "")
}
