...
func TestFlusherLokiExportDefaultProtocol(t *testing.T) {
	var flushed int
	err := exportutil.ExportLogOnly(mixedLogMetricSpanGroups(), "", "", "", func(_ string, _ string, _ string, logGroupList []*protocol.LogGroup) error {
