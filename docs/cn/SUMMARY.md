...
* 输入插件
  ...
  * 原生输入插件
    ...
    * [Prometheus 抓取](plugins/input/native/input-prometheus.md)
...
* 处理插件
  ...
  * 原生处理插件
    ...
    * [Apsara 解析](plugins/processor/native/processor-parse-apsara-native.md)
  ...
  * 扩展处理插件
    ...
    * [锚点](plugins/processor/extended/processor-anchor.md)
    * [追加字段](plugins/processor/extended/processor-appender.md)
    * [Base64 解码](plugins/processor/extended/processor-base64-decoding.md)
    * [Base64 编码](plugins/processor/extended/processor-base64-encoding.md)
    * [添加云资产信息](plugins/processor/extended/processor-cloudmeta.md)
    * [CSV 解析](plugins/processor/extended/processor-csv.md)
    ...
    * [MD5](plugins/processor/extended/processor-md5.md)
    ...
    * [保留/剔除字段](plugins/processor/extended/processor-pick-key.md)
    ...
    * [日志字符串切分](plugins/processor/extended/processor-split-log-string.md)
...
* 输出插件
  ...
  * 原生输出插件
    ...
    * [Kafka（C++）](plugins/flusher/native/flusher-kafka.md)
  ...
  * 扩展输出插件
    ...
    * [Apache Doris](plugins/flusher/extended/flusher-doris.md)
...
* 插件开发
  ...
  * 插件文档开发
    * [如何生成插件文档](developer-guide/plugin-development/plugin-docs/how-to-generate-plugin-docs.md)
