...
LoongCollector 则立足日志场景，通过持续完善指标、跟踪等场景实现更全面的 OneAgent 采集能力；依托性能、稳定性、采集配置灵活性、可编程性优势，打造核心能力的差异化；同时，借助强大的管控能力，提供了大规模采集配置管理能力。更多详见下表，绿色部分为优势项。
...
| | 流水线处理能力 | 多语言采集配置流水线，可组合性高 | 基于 Tag Match 实现 | 基于 Connector 插件 | 基于 Inputs 参数指定上游插件 |
