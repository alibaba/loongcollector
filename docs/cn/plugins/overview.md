...
| `flusher_datahub`<br>[Prometheus](flusher/extended/flusher-datahub.md)                | 社区<br>                                            | 将采集到的数据，输出到阿里云数据总线 Datahub。 |
| `flusher_odps`<br>[Prometheus](flusher/extended/flusher-odps.md)                      | 社区<br>                                            | 将采集到的数据，输出到阿里云大数据计算服务 Odps。 |
