...
func (s *containerConfigTestSuite) TestCompareEnvAndLabelAndRecordContainer() {
	...
	cMap := dockercenter.GetContainerMap()
	cMap["test"] = info
...
func mockDockerInfoDetail(containerName string, envList []string) *dockercenter.DockerInfoDetail {
	...
	return dockercenter.CreateContainerInfoDetail(dockerInfo, *flags.LogConfigPrefix, false)
}
