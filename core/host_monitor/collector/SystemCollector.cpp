...
int SystemCollector::Init(int totalCount) {
    ...
    mCount = 0;
    mCpuCoreCount = static_cast<double>(std::thread::hardware_concurrency());
    mCpuCoreCount = mCpuCoreCount < 1 ? 1.0 : mCpuCoreCount;
    return 0;
}
...
bool SystemCollector::GetHostSystemLoadStat(SystemStat& systemload) {
    ...
    systemload.load1PerCore = systemload.load1 / mCpuCoreCount;
    systemload.load5PerCore = systemload.load5 / mCpuCoreCount;
    systemload.load15PerCore = systemload.load15 / mCpuCoreCount;
