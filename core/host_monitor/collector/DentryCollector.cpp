...
DEFINE_FLAG_INT32(basic_host_monitor_dentry_collect_interval,
                  "basic host monitor dentry collect interval, seconds", 5);
...
const std::chrono::seconds DentryCollector::GetCollectInterval() const {
  return std::chrono::seconds(
      INT32_FLAG(basic_host_monitor_dentry_collect_interval));
}

bool DentryCollector::Collect(HostMonitorContext &collectContext,
  ...
  multiDoubleValues->SetValue(
      ...
      UntypedMultiDoubleValue{UntypedValueMetricType::MetricTypeGauge,
                              static_cast<double>(info.stat.nrDentry)});
  multiDoubleValues->SetValue(
      std::string("dentry_unused"),
      UntypedMultiDoubleValue{UntypedValueMetricType::MetricTypeGauge,
                              static_cast<double>(info.stat.nrUnused)});
  multiDoubleValues->SetValue(
      std::string("dentry_age_limit"),
      UntypedMultiDoubleValue{UntypedValueMetricType::MetricTypeGauge,
                              static_cast<double>(info.stat.ageLimit)});
  multiDoubleValues->SetValue(
      std::string("dentry_want_pages"),
      UntypedMultiDoubleValue{UntypedValueMetricType::MetricTypeGauge,
                              static_cast<double>(info.stat.wantPages)});
  multiDoubleValues->SetValue(
      std::string("dentry_negative"),
      UntypedMultiDoubleValue{UntypedValueMetricType::MetricTypeGauge,
                              static_cast<double>(info.stat.nrNegative)});
