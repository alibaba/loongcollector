...
bool InputNetworkObserver::Init(const Json::Value& config, Json::Value&) {
    ...
    static const std::unordered_map<std::string, MetricType> kMetricKeys = {
        ...
        // {METRIC_RUNNER_EBPF_NETWORK_OBSERVER_CONNECTION_NUM, MetricType::METRIC_TYPE_INT_GAUGE},
        ...
        {METRIC_RUNNER_EBPF_META_ATTACH_SUCCESS_TOTAL, MetricType::METRIC_TYPE_COUNTER},
        {METRIC_RUNNER_EBPF_META_ATTACH_FAILED_TOTAL, MetricType::METRIC_TYPE_COUNTER},
        {METRIC_RUNNER_EBPF_META_ATTACH_ROLLBACK_TOTAL, MetricType::METRIC_TYPE_COUNTER},
    };
