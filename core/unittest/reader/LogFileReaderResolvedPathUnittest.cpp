...
public:
    static void SetUpTestCase() {
        ...
        AppConfig::GetInstance()->SetLogtailSysConfDir(logPathDir);
    }
...
void LogFileReaderResolvedPathUnittest::TestResolveHostLogPathNormalFile() {
    ...
    LogFileReader reader(
        logPathDir, fileName, DevInode(), std::make_pair(&readerOpts, &ctx), std::make_pair(&multilineOpts, &ctx));
...
void LogFileReaderResolvedPathUnittest::TestResolveHostLogPathSymbolicLink() {
    ...
    LogFileReader reader(
        logPathDir, linkName, DevInode(), std::make_pair(&readerOpts, &ctx), std::make_pair(&multilineOpts, &ctx));
