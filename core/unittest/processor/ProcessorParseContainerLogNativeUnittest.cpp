...
// TC-DOCKER-PARTIAL-01: Docker JSON partial log 设置 PartLogFlag 和 HAS_PART_LOG
void ProcessorParseContainerLogNativeUnittest::TestDockerJsonPartialLogBasic() {
    Json::Value config;
    config["IgnoringStdout"] = false;
    config["IgnoringStderr"] = false;
    ProcessorParseContainerLogNative processor;
    ...
    std::string inJson = R"({
        "events": [
            {
                "contents": {
                    "content": "{\"log\":\"Exception in thread \",\"stream\":\"stdout\",\"time\":\"2024-02-19T03:49:37.793533014Z\"}"
                },
                "timestamp": 12345678901,
                "timestampNanosecond": 0,
                "type": 1
            ...
            {
                "contents": {
                    "content": "{\"log\":\"'main' java.lang.\",\"stream\":\"stdout\",\"time\":\"2024-02-19T03:49:37.793533014Z\"}"
                },
                "timestamp": 12345678901,
                "timestampNanosecond": 0,
                "type": 1
            ...
            {
                "contents": {
                    "content": "{\"log\":\"NullPointerException\\n\",\"stream\":\"stdout\",\"time\":\"2024-02-19T03:49:37.793533014Z\"}"
                },
                "timestamp": 12345678901,
                "timestampNanosecond": 0,
                "type": 1
...
// TC-DOCKER-PARTIAL-02: Docker JSON partial log 全链路 Split→Parse→MergeByFlag
void ProcessorParseContainerLogNativeUnittest::TestDockerJsonPartialLogWithSplit() {
    auto sourceBuffer = std::make_shared<SourceBuffer>();
    PipelineEventGroup eventGroup(sourceBuffer);
    eventGroup.SetMetadata(EventGroupMetaKey::LOG_FORMAT, ProcessorParseContainerLogNative::DOCKER_JSON_FILE);
    std::stringstream inJson;
...
// TC-DOCKER-PARTIAL-03: Docker JSON partial log 四步全链路 Split→Parse→MergeByFlag→MergeByRegex
void ProcessorParseContainerLogNativeUnittest::TestDockerJsonPartialLogWithSplitAndRegex() {
    auto sourceBuffer = std::make_shared<SourceBuffer>();
    PipelineEventGroup eventGroup(sourceBuffer);
    eventGroup.SetMetadata(EventGroupMetaKey::LOG_FORMAT, ProcessorParseContainerLogNative::DOCKER_JSON_FILE);
    std::stringstream inJson;
    ...
    // ProcessorMergeMultilineLogNative BY_REGEX
    {
        Json::Value config;
        config["StartPattern"] = LOG_BEGIN_REGEX;
        config["MergeType"] = "regex";
