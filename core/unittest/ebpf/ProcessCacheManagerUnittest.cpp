...
void ProcessCacheManagerUnittest::TestFinalizeProcessTags() {
    ...
    execveEvent->mParent = pExecveEvent;
    ...
    auto processCacheValue = mWrapper.mProcessCacheManager->AttachProcessData(key.pid, key.time, *sharedEvent, sharedEventGroup);
    APSARA_TEST_NOT_EQUAL(processCacheValue, nullptr);
