...
void NetworkObserverConfigUpdateUnittest::AddConfig() {
    ...
    options.mApmConfig = {.mWorkspace = "w1", .mAppName = "app1", .mAppId = "id1", .mLanguage = "go", .mServiceId = "sid1"};
...
void NetworkObserverConfigUpdateUnittest::ConfigAndContainerOrthogonal() {
    ...
    opt1.mApmConfig = {.mWorkspace = "w1", .mAppName = "app1", .mAppId = "id1", .mLanguage = "go", .mServiceId = "sid1"};
    ...
    opt2.mApmConfig = {.mWorkspace = "w2", .mAppName = "app2", .mAppId = "id2", .mLanguage = "go", .mServiceId = "sid2"};
