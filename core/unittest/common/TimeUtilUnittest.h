...
void TimeUtilUnittest::TestStrptimeNanosecond() {
    ...
    std::vector<Case> cases{
        ...
        {"1325430307123456", "%s%f", "1325430307", "%s", 123456000},
        {"1325430307123456789", "%s%f", "1325430307", "%s", 123456789},
        {"1776235692.2729697", "%s.%f", "1776235692", "%s", 272969700},
        {"1776235692.2729697123", "%s.%f", "1776235692", "%s", 272969712},
        {"1776235692.2729697123Z", "%s.%fZ", "1776235692Z", "%sZ", 272969712},
        // the behavior of `strptime_ns` is different with C++ `strptime` in this case
        {"1325430307123456", "%s", "1325430307", "%s", 123456000},
