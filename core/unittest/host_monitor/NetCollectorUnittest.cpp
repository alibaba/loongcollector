...
void NetCollectorUnittest::TestCollect() const {
    ...
    vector<string> rate_names = {
        ...
        "networkin_errorpackages_avg",
        "networkin_errorpackages_max",
        "networkin_errorpackages_min",
        "networkin_rate_avg",
        "networkin_rate_max",
        "networkin_rate_min",
        "networkin_packages_avg",
        "networkin_packages_max",
        "networkin_packages_min",
