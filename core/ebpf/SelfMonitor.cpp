...
// void eBPFSelfMonitorMgr::Init(const logtail::ebpf::PluginType type,
...
// void eBPFSelfMonitorMgr::Release(const logtail::ebpf::PluginType type) {
//     if (!mInited[int(type)])
//         return;
...
// void eBPFSelfMonitorMgr::Suspend(const logtail::ebpf::PluginType type) {
//     if (!mInited[int(type)]) {
//         return;
//     }
//     mInited[int(type)] = false;
