...
public:
    HttpRetryableEvent(int retryLimit, const std::shared_ptr<HttpRecord>& record, moodycamel::BlockingConcurrentQueue<std::shared_ptr<CommonEvent>>& queue)
...
private:
    ...
    // record ...
    std::shared_ptr<HttpRecord> mRecord;
