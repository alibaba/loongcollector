...
public:
    ...
    int ConsumePerfBuffer(void* pb) { return perf_buffer__consume((struct perf_buffer*)pb); }

    int GetPerfBufferEpollFd(void* pb) { return perf_buffer__epoll_fd((struct perf_buffer*)pb); }
