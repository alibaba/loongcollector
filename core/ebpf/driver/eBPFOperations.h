...
typedef void (*perf_process_event_fn)(void* ctx, int cpu, void* data, uint32_t size);
...
// using lookup_inner_map_elem_func = int (*)(logtail::ebpf::PluginType, ebpf_map_name, const char*, void*, void*,
// void*); using update_inner_map_elem_func = int (*)(logtail::ebpf::PluginType, ebpf_map_name, const char*, void*,
// void*, void*, uint64_t);
...
using create_perf_buffer_func
    = void* (*)(logtail::ebpf::PluginType, const char*, int, void*, perf_process_event_fn, perf_loss_event_fn);
...
// int delete_inner_map(logtail::ebpf::PluginType type, ebpf_map_name map, const char* outter_map_name, void*
// outter_key); int delete_inner_map_elem(logtail::ebpf::PluginType type, ebpf_map_name map, const char*
// outter_map_name, void* outter_key, void* inner_key); int lookup_inner_map_elem(logtail::ebpf::PluginType type,
// ebpf_map_name map, const char* outter_map_name, void* outter_key, void* inner_key, void* inner_val); int
// update_inner_map_elem(logtail::ebpf::PluginType type, ebpf_map_name map, const char* outter_map_name, void*
// outter_key, void* inner_key, void* inner_value, uint64_t flag);

// map ops
int search_map_fd(logtail::ebpf::PluginType type, const char* map_name);
int create_bpf_map(logtail::ebpf::PluginType type,
...
void* create_perf_buffer(logtail::ebpf::PluginType type,
                         const char* map_name,
                         int page_cnt,
                         void* ctx,
                         perf_process_event_fn data_cb,
                         perf_loss_event_fn loss_cb);
 ...
 */
// control plane
int init_network_observer(char* btf,
                          int32_t btf_size,
                          char* so,
                          int32_t so_size,
                          long uprobe_offset,
