...
// }
// int delete_inner_map_elem(logtail::ebpf::PluginType type, ebpf_map_name map, const char* outter_map_name, void*
// outter_key, void* inner_key) {
//   return security_bpf_wrapper->DeleteInnerMapElem<decltype(maps[int(map)])>(std::string(outter_map_name), outter_key,
//   inner_key);
// }
// int lookup_inner_map_elem(logtail::ebpf::PluginType type, ebpf_map_name map, const char* outter_map_name, void*
// outter_key, void* inner_key, void* inner_val) {
//   return security_bpf_wrapper->LookupInnerMapElem<decltype(maps[int(map)])>(std::string(outter_map_name), outter_key,
//   inner_key, inner_val);
// }
// int update_inner_map_elem(logtail::ebpf::PluginType type, ebpf_map_name map, const char* outter_map_name, void*
// outter_key, void* inner_key, void* inner_value, uint64_t flag) {
//   return security_bpf_wrapper->UpdateInnerMapElem<decltype(maps[int(map)])>(std::string(outter_map_name), outter_key,
//   inner_key, inner_value, flag);
// }
