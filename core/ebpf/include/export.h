...
public:
    ...
    explicit ApplicationBatchEvent(const std::string& app_id, std::vector<std::pair<std::string, std::string>>&& tags)
        : app_id_(app_id), tags_(tags) {}
    explicit ApplicationBatchEvent(const std::string& app_id,
