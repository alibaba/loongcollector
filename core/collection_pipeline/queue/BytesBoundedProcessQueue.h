...
#include "collection_pipeline/queue/BytesBoundedQueueInterface.h"
...
class BytesBoundedProcessQueue : public BytesBoundedQueueInterface<std::unique_ptr<ProcessQueueItem>>,
