...
REM Change to where cmake locates (GitHub Actions uses VS2022)
if not defined CMAKE_BIN (
    set CMAKE_BIN="C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake"
)
if not exist %CMAKE_BIN% (
    set CMAKE_BIN="C:\Program Files\Microsoft Visual Studio\2022\Professional\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake"
)
if not exist %CMAKE_BIN% (
...
REM Change to where devenv locates (GitHub Actions uses VS2022)
set DEVENV_BIN="C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com"
if not exist %DEVENV_BIN% (
    set DEVENV_BIN="C:\Program Files\Microsoft Visual Studio\2022\Professional\Common7\IDE\devenv.com"
)
if not exist %DEVENV_BIN% (
    set DEVENV_BIN="C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\devenv.com"
)
...
REM Use VS2022 generator instead of VS2017
...
REM Use MSBuild instead of devenv for better CI/CD support
...
REM Create dist directory and package
mkdir dist
cd %LOONGCOLLECTOR_SRC_PATH%
powershell -Command "Compress-Archive -Path 'output\*' -DestinationPath 'dist\loongcollector-%LOONCOLLECTOR_VERSION%.windows-amd64.zip' -Force"
