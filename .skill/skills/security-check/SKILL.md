...
```bash
bash .skill/skills/security-check/scripts/security_check.sh commit
```
...
```bash
bash .skill/skills/security-check/scripts/security_check.sh push
```
...
bash .skill/skills/security-check/scripts/security_reset.sh
```
